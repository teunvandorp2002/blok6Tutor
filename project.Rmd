...
write.xlsx(fitWCFS1, "foldChanges.xlsx", sheetName = "All Data WCFS1", col.names = T,
           row.names = T, append = F)
write.xlsx(resWCFS1, "foldChanges.xlsx", sheetName = "Highest Values WCFS1", col.names = T,
           row.names = T, append = T)
write.xlsx(fitNC8, "foldChanges.xlsx", sheetName = "All Data NC8", col.names = T,
           row.names = T, append = T)
write.xlsx(resNC8, "foldChanges.xlsx", sheetName = "Highest Values NC8", col.names = T,
           row.names = T, append = T)
```
